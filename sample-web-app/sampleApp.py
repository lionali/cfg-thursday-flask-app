...
def myhoroscope():
	...
	date.month
	dm=date.day + date.month


	return render_template ("showmyhoroscope.html", data=dm) # render_template method is a special function flask which redirect to the html file mentioned in the paramter
